...
function! s:init_definitions()
  ...
  let b:wsh_switch_decrement_definitions = dec
endfunction
if !exists('b:wsh_switch_custom_definitions') ||
...
call add(b:switch_custom_definitions,    b:wsh_switch_custom_definitions)
call add(b:switch_increment_definitions, b:wsh_switch_increment_definitions)
call add(b:switch_decrement_definitions, b:wsh_switch_decrement_definitions)
