...
" @author      DeaR
" @timestamp   <2013-06-19 01:53:17 DeaR>
...
let b:undo_ftplugin .= '
  ...
  \   v:val isnot b:python_switch_custom_definitions") |
  \ call filter(b:switch_increment_definitions, "
  \   !exists(\"b:python_switch_increment_definitions\") ||
  \   v:val isnot b:python_switch_increment_definitions") |
  \ call filter(b:switch_decrement_definitions, "
  \   !exists(\"b:python_switch_decrement_definitions\") ||
  \   v:val isnot b:python_switch_decrement_definitions")'
