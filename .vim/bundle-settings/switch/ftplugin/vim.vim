...
" @author      DeaR
" @timestamp   <2013-06-19 02:02:21 DeaR>
...
let b:undo_ftplugin .= '
  ...
  \   v:val isnot b:vim_switch_custom_definitions") |
  \ call filter(b:switch_increment_definitions, "
  \   !exists(\"b:vim_switch_increment_definitions\") ||
  \   v:val isnot b:vim_switch_increment_definitions") |
  \ call filter(b:switch_decrement_definitions, "
  \   !exists(\"b:vim_switch_decrement_definitions\") ||
  \   v:val isnot b:vim_switch_decrement_definitions")'
